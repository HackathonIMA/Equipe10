...
namespace ima.Api.V1.Model
{
    ...
    public class EducacaoResponse
    {
        ...
        [DataMember(Name = "endereco_escola", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnderecoEscolaDemanda: ").Append(EnderecoEscola).Append("\n");

            sb.Append("  LogradouroDemanda: ").Append(Logradouro).Append("\n");

            sb.Append("  MunicipioDemanda: ").Append(Municipio).Append("\n");

            sb.Append("  UfDemanda: ").Append(Uf).Append("\n");

            sb.Append("  CepDemanda: ").Append(cep).Append("\n");
